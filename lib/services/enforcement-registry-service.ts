...
export function buildSubsystemEnforcementDeclarations(): SubsystemEnforcementDeclaration[] {
  return [
    ...
    d({
      ...
      primaryRuntimeId: RUNTIME_ID_BOOK1_REGENERATION,
      canonicalOutputEffectClass: "advisory_shaping",
      semanticTruthNotes: "Derivation integrated in regeneration outputs; not production scene enforcement.",
      validationFlags: ["regeneration_centric"],
    }),
    d({
      ...
      primaryRuntimeId: RUNTIME_ID_BOOK1_REGENERATION,
      canonicalOutputEffectClass: "advisory_shaping",
      semanticTruthNotes: "Cockpit summary + diagnostics; regeneration-centric.",
      validationFlags: ["regeneration_centric"],
    }),
    d({
      subsystemId: "hcel_hook_layer",
      subsystemName: "HCEL / hook-layer (if present in regeneration bundle)",
      enforcementClass: "advisory_runtime",
      authorityClass: "advisory_runtime",
      participatesInCanonicalRuntime: false,
      affectsCanonicalOutput: false,
      ...
      primaryRuntimeId: RUNTIME_ID_BOOK1_REGENERATION,
      canonicalOutputEffectClass: "advisory_shaping",
      semanticTruthNotes: "Treated as hook/continuity signals in book1 regeneration artifacts, not production gates.",
      validationFlags: ["regeneration_centric", "alias_hcel"],
    }),
    d({
      ...
      primaryRuntimeId: RUNTIME_ID_BOOK1_REGENERATION,
      canonicalOutputEffectClass: "advisory_shaping",
      semanticTruthNotes: "Derivation for regeneration/cockpit; not wired as production hard gate.",
      validationFlags: ["regeneration_centric"],
    }),
    d({
