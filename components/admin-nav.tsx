...
const links = [
  ...
  { href: "/admin/world-states", label: "World states" },
  { href: "/admin/pressure/governance", label: "Pressure (gov)" },
  { href: "/admin/pressure/bundles", label: "Pressure bundles" },
  { href: "/admin/relationships", label: "Relationships (Stage 6)" },
  ...
  { href: "/admin/continuity/education", label: "Education norms (6.5)" },
