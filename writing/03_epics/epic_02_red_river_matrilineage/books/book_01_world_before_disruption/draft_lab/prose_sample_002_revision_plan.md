...
- Clear desires: **place**, competence, not being measured only by cousin legs.
- Physical literacy: knots failing under performance pressure; pocket shell; cord shadow.
- Emotional range: pride, shame, stubbornness, tenderness without sentimentality speech.

## Child-World Strengths

- Cousin rivalry and pack logic (“underfoot,” sunny patch ownership).
- Adult laughter that is not quite ridicule — real social risk.

## Matriarchal Inheritance Strengths

- Grandmother’s authority: tap, wait, two-finger correction, dry humor.
- Mother’s authority: wrist catch, instruction, coil marker with double meaning.

## Binding Future Strengths
...
- Occasional elevated phrasing; keep RevB’s **action-first** median when revising.

## Cultural / Historical Research Flags
