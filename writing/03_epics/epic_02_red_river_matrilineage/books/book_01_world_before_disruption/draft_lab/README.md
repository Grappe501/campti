# Draft lab — Book 01 controlled prose tests

Canon status: PROPOSED

## Purpose

Isolated **prose experiments** for voice, scale, sensory density, and women-centered power—without `ch_###` chapter folders, without locking **Chapter 1**, without `writing/01_canon/`.
...
| File | Movement | Role |
|------|----------|------|
| `prose_sample_001_opening_matriarch_first_image.md` | I-A | First draft (**001**) — baseline |
| `prose_sample_001_opening_matriarch_first_image_revA.md` | I-A | **RevA** — world-entry revision |
| `prose_sample_001_opening_matriarch_first_image_revB.md` | I-A | **RevB** — matriarchal authority lock; **provisional tonal model** |
| `archive/prose_sample_001_original.md` | — | Snapshot: **001** before RevA |
| `archive/prose_sample_001_revA.md` | — | Snapshot: **RevA** before RevB |
| `prose_sample_001_notes.md` | — | Critique — **001** |
| `prose_sample_001_revision_plan.md` | — | Plan before RevA |
| `prose_sample_001_revA_notes.md` | — | RevA vs **001** |
| `prose_sample_001_revB_notes.md` | — | RevB vs RevA |
| `prose_sample_review_gate.md` | — | Gates — **001** |
...
- `../book01_chapter_candidates_v0/`
- `../book01_symbol_braid_v0/`
